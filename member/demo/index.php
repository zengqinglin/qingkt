...
<script type="text/javascript">
 ...
 <?php  if(!isset($_GET['act'])){ ?>
  ...
  <?php  if(isset($_GET['act']) && $_GET['act'] == "upload"){ ?>
	...
	<div style="float:left;"><img id="target" src="<?php echo $path ?>"  ></div>
		<div style="width:190px;height:195px;margin:10px;overflow:hidden; float:left;"><img  style="float:left;" id="preview2" src="<?php echo $path ?>" ></div>
