 ...
 * @return    string
 */
function ch_vlinks($fvalue, &$ctag, &$refObj, $fname='', $downloadpage=false)
{
	die("ab bb");
    global $dsql;
    ...
    {
        return ch_vlinks_all($fvalue, $ctag, $refObj, $row);
    }
	
}

//读取所有链接地址
function ch_vlinks_all($fvalue, &$ctag, &$refObj, &$row)
{
