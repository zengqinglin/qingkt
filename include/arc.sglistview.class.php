...
class SgListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno,small")
    { 
        ...
        {
            $endpage="<span class=\"disabled_page\">尾页</span>";
        }
        ...
        */
        ...
        for($j; $j <= $total_list; $j++)
        {
            if($j == $this->PageNo)
            {  
                $listdd.= "<a href=\"javascript:void(0)\" class=\"active\">$j</a>\r\n";
            }
            else
            {
        ...
        if(preg_match('/option/i', $listitem))
        {
		 ...
		 if(preg_match('/small/i', $listitem))
        {
            $plist .= $small;
        }
        return $plist;
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            return "<span class=\"disabled_page\">共1页/".$this->TotalResult."条记录</span>";
        }
        if($this->TotalResult == 0)
        {
            return "<span class=\"disabled_page\">共0页/".$this->TotalResult."条记录</span>";
        }
        $purl = $this->GetCurUrl();
