...
class ListView
{
    ...
    function CountRecord()
    {
		...
		if($this->iseasy!=""){
			 $this->addSql  = "arc.arcrank > -1 AND (qkt_addonsoft17.level =  '".$this->iseasy."')";
			}else{
        ...
        if($cfg_list_son=='N')
        {
            ...
            {
                if($this->CrossID=='') $this->addSql .= " AND (arc.typeid='".$this->TypeID."') AND (AND qkt_addonsoft17.level =  '".$this->iseasy."')";
        ...
        {
			if($this->iseasy!=""){
			$cquery = "SELECT COUNT(*) AS dd FROM `#@__arctiny` arc  LEFT JOIN `qkt_addonsoft17` ON arc.id 

= qkt_addonsoft17.aid WHERE ".$this->addSql;
				}else{
    ...
    $imgwidth=120,$imgheight=90,$listtype="all",$orderby="default",$innertext="",$tablewidth="100",$ismake=1,$orderWay='desc')
    {
        ...
        else
        {
            ...
            $ids = array();
		if($this->iseasy!=""){
			 $query = "SELECT id FROM `#@__arctiny` arc  LEFT JOIN `qkt_addonsoft17` ON arc.id 

= qkt_addonsoft17.aid  WHERE {$this->addSql} $ordersql LIMIT $limitstart,$row ";
			}else{
            ...
            else
            {
				...
				if($this->iseasy!=""){
					$query = "SELECT arc.*,tp.typedir,tp.typename,tp.corank,tp.isdefault,tp.defaultname,
                       ...
                       $addJoin
                       WHERE arc.id  in($idstr) AND qkt_addonsoft17.level='{$this->iseasy}' $ordersql ";
					$query2= "WHERE arc.id in($idstr) AND qkt_addonsoft17.level='{$this->iseasy}' $ordersql ";
